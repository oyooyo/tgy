...
#elif defined(bs_nfet_reverse_esc)
#include "bs_nfet_reverse.inc"		; HobbyKing BlueSeries / Mystery with all nFETs (INT0 PWM, forward/reverse)
#elif defined(bs_nfet_uart1_esc)
#include "bs_nfet_uart1.inc"		; HobbyKing BlueSeries / Mystery with all nFETs (UART, Motor ID 1)
#elif defined(bs_nfet_uart2_esc)
#include "bs_nfet_uart2.inc"		; HobbyKing BlueSeries / Mystery with all nFETs (UART, Motor ID 2)
#elif defined(bs_nfet_uart3_esc)
#include "bs_nfet_uart3.inc"		; HobbyKing BlueSeries / Mystery with all nFETs (UART, Motor ID 3)
#elif defined(bs_nfet_uart4_esc)
#include "bs_nfet_uart4.inc"		; HobbyKing BlueSeries / Mystery with all nFETs (UART, Motor ID 4)
